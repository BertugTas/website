...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen grid lg:grid-cols-2">
      {/* ── LEFT: text content ─────────────────────────────────────────── */}
      <div className="flex items-center pt-24 pb-16 px-6 lg:pl-[max(1.5rem,calc(50vw-34rem))] lg:pr-14">
        <div className="w-full max-w-lg">
          ...
          {/* Name – nowrap keeps it on one line */}
          <h1 className="font-bold tracking-tight mb-4 leading-none flex flex-nowrap items-baseline gap-x-[0.2em] text-5xl lg:text-6xl xl:text-7xl">
          ...
          <h2
            className="text-lg text-white/55 font-normal mb-10 tracking-wide opacity-0 animate-fade-up"
          ...
          <p
            className="text-white/70 text-base leading-relaxed mb-4 opacity-0 animate-fade-up"
          ...
          <p
            className="text-white/45 text-sm leading-relaxed mb-12 opacity-0 animate-fade-up"
